...
blurb: "If you run a Discord server to accompany your Twitch stream, you probably have a channel dedicated to letting people know when you're livestreaming. I have a solution."
date: "2021-03-08"
coverImage: "../../assets/twitch-discord/cover.webp"
...
![Flowchart between eventsub, aws and discord](../../assets/twitch-discord/goli-flow.png)
...
![Screenshot of twitch console with generated client secret](../../assets/twitch-discord/twitchdash.png)
...
![Screenshot of discord's webhook configuration menu](../../assets/twitch-discord/dischook.png)
...
![Screenshot of the aws console with a successfully created lambda function](../../assets/twitch-discord/lambda.png)
...
![Screenshot of the actions menu for an API](../../assets/twitch-discord/gatewayactions.png)
...
![Screenshot of the configuration menu for setting up an API](../../assets/twitch-discord/gatewayintpoint.png)
...
![Screenshot of the 'deploy api' dialog](../../assets/twitch-discord/gatewaydeploy.png)
...
![Screenshot showing the 'upload zip' button on the lambda dashboard](../../assets/twitch-discord/lambdaupload.png)
...
![Screenshot of the insomnia api client configured for the authentication step](../../assets/twitch-discord/insauth.png)
...
![Screenshot of the insomnia API client configured for the subscription step](../../assets/twitch-discord/inssub.png)
...
![Screenshot of an example output from the script](../../assets/twitch-discord/notif.png)

## Costs

Thanks to AWS free tier, The biggest cost is your time. The estimated annual cost is a whopping $0. You can see the [pricing calculator](https://calculator.aws/#/estimate?id=bc1d43fed2e4a1f18e8fc8002b9626d461a0cdfa), which assumes 100 'go-live' notifications a month.

![Screenshot of AWS pricing calculator](../../assets/twitch-discord/pricing.png)
