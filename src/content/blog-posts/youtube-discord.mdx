...
blurb: "Just like Twitch notifications, notifying your Discord server about your YouTube uploads sounds like something that should be built in. Until it is, I have created a solution using AWS Lambda and API Gateway solutions."
date: "2022-08-22"
coverImage: "../../assets/youtube-discord/cover.webp"
coverImageAlt: "Screenshot of Discord notification messages from the tutorial"
category: "how-to"
---
...
![Flowchart between websub, aws and discord](../../assets/youtube-discord/pipedream-flow.png)

Sign up for [Pipedream](https://pipedream.com), it connects services together like Zapier or IFTT, but it's free for this level of usage and [way more powerful than its competitors](https://techcrunch.com/2022/05/17/2315521/). We're going to connect the YouTube Data API to our Discord Webhook. Navigate [to this Pipedream page](https://pipedream.com/apps/youtube-data-api/integrations/discord-webhook/send-message-with-discord-webhook-api-on-new-videos-in-channel-from-youtube-data-api-api-int_m8sZWGj) and click "Get Started". You'll then be presented with a two-step form, one step being the YouTube data "input", and the Discord Webhook "output". The idea here is that when the input trigger is... triggered, the output is passed the trigger data.

![The two-step form presented by Pipedream](../../assets/youtube-discord/pipedream-step-1.png)
...
![The Discord Webhook setup process](../../assets/youtube-discord/pipedream-step-2.png)
...
![Blue text = substitutes](../../assets/youtube-discord/pipedream-step-3.png)
...
![Flowchart between websub, aws and discord](../../assets/youtube-discord/serverless-flow.png)
...
![The PubSubHubBubLubTub. The callback URL is the webhook reciever and the topic URL is the YouTube 'topic' generated by Google. Notice the extra 'xml' in the URL? That's on purpose, this endpoint is specifically for WebSub.](../../assets/youtube-discord/lambda-websub-1.png)
...
![Your Lambda function setup should look like this](../../assets/youtube-discord/lambda-setup.png)

Next, upload the zip you made earlier. The button can be a little hard to find, but it's here:

![A small dropdown of upload options for Lambda scripts, the highlighted option being 'zip'](../../assets/youtube-discord/lambda-upload.png)
...
![The Lambda trigger creation form](../../assets/youtube-discord/lambda-trigger-setup.png)

Clicking the 'Add' button at the bottom should then redirect you to a view like this:

![The lambda trigger, set up with all the details like the name of the API Gateway, the URL of the gateway, and the path](../../assets/youtube-discord/lambda-trigger-confirm.png)
...
![A screenshot of the setup dialog for Superfeedr, with fields filled as detailed above](../../assets/youtube-discord/lambda-superfeedr-setup.png)
