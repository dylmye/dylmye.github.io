...
blurb: "AI JS, fresh outta TC39 and a throwback to the 80s..."
date: "2018-12-01"
coverImage: "../../assets/redriver-ffconf/cover.webp"
coverImageAlt: "The audience of ffconf jumping and cheering in a theatre"
...
![Here we see Tensorflow.js plotting polynomial regression. (Credit: Elle Haproff / FFConf)](../../assets/redriver-ffconf/ffconf-tensorflowdemo.png)
...
![The title card for the Bind Operator. (credit: Willian Martins / FFConf)](../../assets/redriver-ffconf/ffconf-bindop.png)
...
![The title card for the Pipe Operator. (credit: Willian Martins / FFConf)](../../assets/redriver-ffconf/ffconf-pipeop.png)
...
![A demonstration of the partial application syntax for a template literal. (credit: Willian Martins / FFConf)](../../assets/redriver-ffconf/ffconf-partialapply.png)
