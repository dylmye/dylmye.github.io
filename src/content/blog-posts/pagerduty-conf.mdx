...
blurb: "I went to the PagerDuty conference, here's what I learned..."
date: "2019-06-19"
coverImage: "../../assets/pagerduty-conf/cover.webp"
coverImageAlt: "A PagerDuty Connect lanyard and badge in focus, with a 'welcome' presentation behind"
category: "conf-recap"
---
...
![A high level of DAZN's infrastructure. It's a lot.](../../assets/pagerduty-conf/dazn-architecture.webp)
...
![1. Shadow rotations to encourage learning. 2. Runbooks to document the undocumented. 3. People on-call when it makes sense for you.](../../assets/pagerduty-conf/monzo-conclusion.webp)
