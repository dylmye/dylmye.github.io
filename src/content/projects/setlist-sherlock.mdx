...
blurb: "A mobile app that makes finding concert setlists a breeze"
date: "2024-02-18"
coverImage: "../../assets/setlist-sherlock/cover.webp"
url: "https://play.google.com/store/apps/details?id=com.dylmye.setlists"
...
![Advanced search filters are supported, unlike other Setlist.fm-based apps available](../../assets/setlist-sherlock/setlist-sherlock-2.webp)
...
![All of the details for a setlist are easily findable without scrolling](../../assets/setlist-sherlock/setlist-sherlock-3.webp)
