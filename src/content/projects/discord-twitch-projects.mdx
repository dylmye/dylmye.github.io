...
blurb: "Experimenting with multiple APIs to improve streamer's UX"
date: "2021-04-01"
coverImage: "../../assets/discord-twitch-projects/cover.webp"
tags: ["javascript", "python", "discord", "twitch"]
---
...
I created a system from scratch to deliver these notifications practically as soon as the streamer went live, which I have deployed in a dozen Discord servers with no issues. I wrote [a technical guide](../blog/twitch-discord) on implementation, and open-sourced the infrastructure and code.

Building on the success of this, and to build on feedback from streamers, I created a similar system for YouTube uploads. I also wrote [a technical guide](../blog/youtube-discord) for this.
