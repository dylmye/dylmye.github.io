...
- **Domains registered with [QuickHostUK](https://www.quickhost.uk/)**: There are dozens of UK-based eNom resellers but QHUK's edge is their truly fantastic technical support and reasonable prices. As you can tell from their name, the main business is UK-based web + VPS cloud hosting (and UK colo) however their domain product is far from a last-minute thought. I miss the more advanced features Porkbun offers, like managing your own DNSSEC without hosting and more clarity over their WHOIS privacy options, however I'm still happy with my choice. Bonus points earned for carbon neutral offering.
